...
export function FloatingChatButton() {
  ...
  return (
    <button
      onClick={open}
      className="fixed bottom-24 right-6 bg-inox-teal text-white p-4 rounded-full shadow-lg hover:bg-inox-teal/90 hover:scale-110 hover:shadow-xl transition-all duration-300 z-50 group animate-in fade-in slide-in-from-bottom-10 delay-500"
